...
<body class="bg-light">
    <div class="container bg-dark text-light p-3 rounded my-4">
        <div class="d-flex align-items-center justify-content-between">
            <h2><i class="bi bi-bag-check"></i> Service Manager</h2>
    ...
    if (isset($_GET['alert'])) {
        if ($_GET['alert'] == 'img_rem_fail') {
            echo <<<alert
                                ...
                                <strong>Slot Removal Fail! Server Down</strong>
        ...
        if ($_GET['alert'] == 'remove_failed') {
            echo <<<alert
                                <div class="container alert alert-danger alert-dismissible text-center" role="alert">
                                <strong>Cannot Remove slot Server Down</strong>
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                </div>
        ...
        if ($_GET['success'] == 'removed') {
            echo <<<alert
                                ...
                                <strong>Service Slot Deleted </strong>
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                </div>
        ...
        <table class="table table-hover text-center">
            <thead class="bg-dark text-light">
                <tr>
                    ...
                    <th width="10%" scope="col">Service Type</th>
                    <th width="10%" scope="col">Vehicle Registration Number</th>
                    <th width="10%" scope="col">Date and Time</th>
                    <th width="20%" scope="col">Remark</th>
